...
void HashTable::Insert(Bid bid) {
    ...
    // try and retrive the node using the key
    Node* oldNode = &(nodes.at(key));

    // If no empty found for this key
    if (oldNode == nullptr) {
...
void HashTable::PrintAll() {
    ...
    // Loop through the nodes and print their contents
...
Bid HashTable::Search(string bidId) {
    ...
    // Walk the linke list to find the match
    while (node != nullptr) {
